...
function createHtml(features,products,commonFeatures){
    ...
    html+= '<div class="card-game__cards"><button class="scrollbutton" onclick="leftScroll()">&lt;</button><ul class="card-game__cards-list">' +products.map((product,index)=>createPlanHtml(index,product,commonFeatures)).join('') +'</ul> <button class="scrollbutton" onclick="rightScroll()">&gt;</button></div>';
